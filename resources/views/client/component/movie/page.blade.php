...
@section('content')
    ...
    <div>
        <div class="movie_image_1">
            <img
                src="https://snagfilms-a.akamaihd.net/dd078ff5-b16e-45e4-9723-501b56b9df0a/images/2023/04/19/1681926242070_3840x1080_32x9Images.jpg?impolicy=resize&w=1366&h=384.1875"
    ...
    <div class="home-categories" style="padding-top: 10px; padding-bottom: 10px">
        <div class="d-flex justify-content-between align-items-center">
            <div class="d-flex align-items-center movies-info">
                <h3>UNISH 20</h3>
                <h6 class="m-0 ms-3">Length 114min | Romantic | 9.4</h6>
            </div>
            <div class="share">
                ...
                <div class="d-flex">
                    <div class="thumbnail me-2">
                        <div class="image position-relative d-flex justify-content-center align-items-center">
                            <img
                                src="https://snagfilms-a.akamaihd.net/dd078ff5-b16e-45e4-9723-501b56b9df0a/images/2023/04/21/1682065562556_as_episode01_16x9Images.jpg?impolicy=resize&w=200&h=121"
                                style="max-width: 200px;height: 150px;opacity: 0.6";
                            >
                    ...
                    <div class="episode-description">
                        <h2>Season 1 : E1</h2>
                        <h3>মাইশেলফ অ্যালেন স্বপন পর্ব ০১</h3>
                        <p>
        ...
        <h4 class="text-danger">Eposode 1</h4>
        <hr>
